        ...
        <div id="page-inner">
            ...
            <div class="table-responsive">
                <form method="post">
                    ...
                    <input type="text" name="name" id="" class="form-control" style="margin-bottom: 10px">
                    <input type="submit" value="Create" name="createCategory" class="btn btn-success">
                </form>
            </div>
        </div>
        <!-- /. PAGE INNER  -->
