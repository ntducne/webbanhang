            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line"><a href="category_create.php" class="btn btn-success">Create</a></h1>
                    </div>
                </div>
                            ...
                            foreach ($categories as $category) : ?>
                                <tr>
                                    ...
                                    <td style="display: flex; align-items: center">
                                        <a href="category_edit.php?id=<?php echo $category['id'] ?>" class="btn btn-warning">Edit</a>
                                        <form method="post">
